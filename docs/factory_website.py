...
class Copyright(Website):
    def __init__(self):
        super().__init__()
        self.html = '''<!-- Copyright -->
            <p>This database consists of short term videos based on several short movies, that are either public available or created by TU Ilmenau.
            The tools provided in <a href="https://github.com/Telecommunication-Telemedia-Assessment/AVT-VQDB-UHD-1">this repository</a> can be used to download the shared videos that are used in the described video quality tests. In the following we specify the common filename prefix, to identify the source and corresponding licence of the video. This applies to encoded and source videos that are shared within this database. For example all files that can be downloaded with the prefix bigbuck_bunny are based on the Big Bucks Bunny content and follow the corresponding licence.</p>
            <br>
            ...
            <h3>Papers using the Dataset</h3>
            This dataset is used in the following papers:
            <ul class="w3-ul w3-hoverable">
                <li>Steve Göring, Rakesh Rao Ramachandra Rao, Bernhard Feiten, and Alexander Raake. <strong>"Modular Framework and Instances of Pixel-based Video Quality Models for UHD-1/4K."</strong> <em>IEEE Access. vol. X. 2021</em> <a href="URL">[url]</a></li>
                <li>Alexander Raake, Silvio Borer, Shahid Satti, Jörgen Gustafsson, Rakesh Rao Ramachandra Rao, Stefano Medagli, Peter List, Steve Göring, David Lindero, Werner Robitza, Gunnar Heikkilä, Simon Broom, Christian Schmidmer, Bernhard Feiten, Ulf Wüstenhagen, Thomas Wittmann, Matthias Obermann, and Roland Bitto. <strong>"Multi-model standard for bitstream-, pixel-based and hybrid video quality assessment of UHD/4K: ITU-T P.1204."</strong><em> IEEE Access. vol. 8. 2020</em> <a href="https://ieeexplore.ieee.org/document/9234526?source=authoralert" target="_blank">[url]</a></li>
                <li>Rakesh Rao Ramachandra Rao, Steve Göring, Werner Robitza, Alexander Raake, Bernhard Feiten, Peter List, and Ulf Wüstenhagen. <strong>"Bitstream-based Model Standard for 4K/UHD: ITU-T P.1204.3 -- Model Details, Evaluation, Analysis and Open Source Implementation."</strong> <em>Twelfth International Conference on Quality of Multimedia Experience (QoMEX)</em>. Athlone, Ireland. May 2020. <a href="https://www.researchgate.net/publication/341792225_Bitstream-based_Model_Standard_for_4KUHD_ITU-T_P12043_-_Model_Details_Evaluation_Analysis_and_Open_Source_Implementation" target="_blank">[url]</a></li>
                <li>Steve Göring, Christopher Krämmer, and Alexander Raake. <strong>"cencro -- Speedup of Video Quality Calculation using Center Cropping."</strong> <em>21st IEEE International Symposium on Multimedia (2019 IEEE ISM)</em>. Dec 2019. <a href="https://www.researchgate.net/publication/338200687_cencro_--_Speedup_of_Video_Quality_Calculation_using_Center_Cropping" rel="nofollow">[url]</a></li>
                <li>Rakesh Rao Ramachandra Rao, Steve Göring, Werner Robitza, Bernhard Feiten, and Alexander Raake. <strong>"AVT-VQDB-UHD-1: A Large Scale Video Quality Database for UHD-1."</strong> <em>21st IEEE International Symposium on Multimedia (2019 IEEE ISM)</em>. Dec 2019. <a href="https://www.researchgate.net/publication/338201010_AVT-VQDB-UHD-1_A_Large_Scale_Video_Quality_Database_for_UHD-1" target="_blank">[url]</a></li>
            </ul>
            <!-- END Copyright -->
            '''
